...
Проект №2. Бизнес-гипотезы: аналитика клиентов банка. Предложены:гипотезы, почему новые поколения (когорты) клиентов банка стали платить хуже, чем предыдущие; методы проверки этих гипотез; гипотезы о методах исправления ситуации; методы проверки того, что ситуация действительно исправлена.
